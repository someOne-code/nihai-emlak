...
export const metadata: Metadata = {
  title: "Ödeme Başarılı | Umut Emlak",
  description: "Kiralama talebiniz ve ödemeniz başarıyla alındı.",
};
        ...
        <div className="container mx-auto max-w-screen-md px-4 text-center">
          <div className="flex flex-col items-center justify-center gap-6 rounded-2xl bg-white dark:bg-[#1a2432] p-8 md:p-16 shadow-property">
            ...
            <p className="text-lg leading-relaxed text-property-gray max-w-lg">
              Tebrikler! Kiralama talebiniz başarıyla alındı ve ön ödemeniz onaylandı. Ekibimiz en kısa sürede belge doğrulama ve kontrat detayları için sizinle iletişime geçecektir.
            </p>
