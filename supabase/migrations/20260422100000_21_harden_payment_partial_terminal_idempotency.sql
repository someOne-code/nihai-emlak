-- Phase 3 / payment callback hardening:
-- Idempotency requires the full successful state tuple. Partial terminal states
-- are audited as conflicts instead of being silently accepted as idempotent.
